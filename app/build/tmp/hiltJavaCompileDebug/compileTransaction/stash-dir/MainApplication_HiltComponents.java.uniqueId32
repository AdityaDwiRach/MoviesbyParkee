...
import id.adr.mobile.moviesbyparkee.di.DatabaseModule;
import id.adr.mobile.moviesbyparkee.di.NetworkModule;
import id.adr.mobile.moviesbyparkee.di.RepositoryModule;
import id.adr.mobile.moviesbyparkee.presentation.detail.DetailFragment_GeneratedInjector;
import id.adr.mobile.moviesbyparkee.presentation.detail.DetailViewModel_HiltModules;
import id.adr.mobile.moviesbyparkee.presentation.favorite.FavoriteFragment_GeneratedInjector;
import id.adr.mobile.moviesbyparkee.presentation.favorite.FavoriteViewModel_HiltModules;
import id.adr.mobile.moviesbyparkee.presentation.home.HomeFragment_GeneratedInjector;
